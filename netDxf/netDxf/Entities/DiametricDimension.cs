namespace netDxf.Entities
{
    ...
    public class DiametricDimension : Dimension
    {
        ...
        public DiametricDimension() : this(Vector2.Zero, Vector2.UnitX, 0.0, DimensionStyle.Default)
        {
        }

        public DiametricDimension(netDxf.Entities.Arc arc, double rotation, double offset) : this(arc, rotation, offset, DimensionStyle.Default)
        {
        }

        public DiametricDimension(Circle circle, double rotation, double offset) : this(circle, rotation, offset, DimensionStyle.Default)
        {
        }

        public DiametricDimension(Vector2 centerPoint, Vector2 referencePoint, double offset) : this(centerPoint, referencePoint, offset, DimensionStyle.Default)
        {
        }

        public DiametricDimension(netDxf.Entities.Arc arc, double rotation, double offset, DimensionStyle style) : base(DimensionType.Diameter)
        {
            if (arc == null)
            {
        ...
        public DiametricDimension(Circle circle, double rotation, double offset, DimensionStyle style) : base(DimensionType.Diameter)
        {
            if (circle == null)
            {
        ...
        public DiametricDimension(Vector2 centerPoint, Vector2 referencePoint, double offset, DimensionStyle style) : base(DimensionType.Diameter)
        {
        ...
        {
            DiametricDimension dimension = new DiametricDimension {
        ...
        public override double Measurement =>
            (2.0 * Vector2.Distance(this.center, this.refPoint));
    }
}
